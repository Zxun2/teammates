...
export class QuestionResponsePanelComponent {
  ...
  canUserSeeResponses(question: FeedbackQuestionModel): boolean {
    const showResponsesTo: FeedbackVisibilityType[] =
      question.feedbackQuestion.showResponsesTo;
      ...
      .subscribe({
        next: (sessionResults: SessionResults) => {
          ...
          if (responses) {
            ...
            question.hasResponseButNotVisibleForPreview =
              responses.hasResponseButNotVisibleForPreview;
            question.hasCommentNotVisibleForPreview =
